...
const mockTransactions = [
  { id: "1", type: "earned" as const, amount: 10, description: "Queue served", timestamp: "2h ago" },
  { id: "2", type: "earned" as const, amount: 10, description: "Queue served", timestamp: "1d ago" },
  { id: "3", type: "redeemed" as const, amount: 5, description: "Premium skip", timestamp: "2d ago" },
];
        ...
        <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6 animate-slide-up">
              {filteredOrgs.map((org) => (
                <OrganizationCard
                  key={org.id}
                  {...org}
                  onQuickJoin={() => setSelectedOrg(org.id)}
                />
              ))}
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              <WalletCard balance={50} transactions={mockTransactions} />
