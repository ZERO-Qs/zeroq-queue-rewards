import { Banknote, PiggyBank, Building, X } from "lucide-react";
...
const services = [
  { id: "withdraw", icon: Banknote, label: "Withdraw", color: "from-green-500 to-emerald-600" },
  { id: "deposit", icon: PiggyBank, label: "Deposit", color: "from-blue-500 to-cyan-600" },
  { id: "loan", icon: Building, label: "Loan Office", color: "from-purple-500 to-pink-600" },
];

export const QuickJoinModal = ({ open, onClose, organizationName }: QuickJoinModalProps) => {
